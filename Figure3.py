...
#%% Performance at Different Training Ratios (Figure 3a)
...
#%% Performance at Different Test Ratios (Figure 3b)
...
def plot_parity_and_density_minimal(trajectories_dict):
    ...
    for m_name in model_names:
        ...
        try:
            ...
            # 不从 0 开始，避免整个右图都被浅色背景覆盖
            fill_levels = np.linspace(0.08, 1.0, 10)
            line_levels = np.linspace(0.15, 0.95, 7)
