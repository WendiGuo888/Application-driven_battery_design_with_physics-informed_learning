...
#%%  Physical Loss, Adaptive Aging Parameter Updates, and Comparison Between NN Predictions and Physical Values (Figures 4a, 4b, and 4d)
...
#%% Loss Landscape Comparison of Four ML Models for Extrapolation Performance Evaluation (Figure 4d)
